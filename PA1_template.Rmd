...
We'll use data.table instead of data.frame, and ggplot2 for graphics.  Allow printing of larger numerics in fixed format.  Read in the data and convert the character date column to the date class.   
